...
(function(){$.fn.jSignature("addPlugin","instance","UndoButton",function(q){this.events.subscribe("jSignature.attachingEventHandlers",function(){if(this.settings[q]){var m=this.settings[q];"function"!==typeof m&&(m=function(){var e=$('<div class="jsignature-undo mvt-wrapper"><span class="fa fa-undo"></span></div><div class="jsignature-save mvt-wrapper"><span class="fa fa-save"></span></div>').appendTo(this.$controlbarLower),k=e.width();k!==e.width()&&e.width(k);return e});var k=m.call(this),
