class medicalRecords {
	...
	template() {
		...
		content = 	`<div class="mvt-page-cover mvt-wrapper mvt-25">
						<div class="mvt-container">
							<div class="mvt-page-cover-content">
								<div class="mvt-page-cover-title mvt-wrapper">medical records</div>
								<div class="mvt-page-cover-subtitle mvt-wrapper">request form</div>
							</div>
						</div>
					</div>
		...
		jQuery.ajax({
            ...
            crossDomain: true,
            dataType: 'json',
            url: 'https://s3-us-west-2.amazonaws.com/dr-annie/data/forms/medical-records-request.json',
